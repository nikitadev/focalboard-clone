...
export function setTheme(theme) {
  ...
  if (Utils.isPlugin()) {
    ...
    style.setProperty(
      ...
      style.getPropertyValue("--center-channel-bg-rgb") ||
        consolidatedTheme.mainBg
    );
    style.setProperty(
      "--center-channel-color-rgb",
      style.getPropertyValue("--center-channel-color-rgb") ||
        consolidatedTheme.mainBg
    );
    style.setProperty(
      "--button-bg-rgb",
      style.getPropertyValue("--button-bg-rgb") || consolidatedTheme.mainBg
    );
    style.setProperty(
      "--button-color-rgb",
      style.getPropertyValue("--button-color-rgb") || consolidatedTheme.mainBg
    );
    style.setProperty(
      "--sidebar-bg-rgb",
      style.getPropertyValue("--sidebar-bg-rgb") || consolidatedTheme.mainBg
    );
    style.setProperty(
      "--sidebar-text-rgb",
      style.getPropertyValue("--sidebar-text-rgb") || consolidatedTheme.mainBg
    );
    style.setProperty(
      "--link-color-rgb",
      style.getPropertyValue("--link-color-rgb") || consolidatedTheme.mainBg
    );
    style.setProperty(
      "--sidebar-text-active-border-rgb",
      style.getPropertyValue("--sidebar-text-active-border-rgb") ||
        consolidatedTheme.mainBg
    );
  } else {
    ...
    document.documentElement.style.setProperty(
      "--center-channel-color-rgb",
      consolidatedTheme.mainFg
    );
    document.documentElement.style.setProperty(
      "--button-bg-rgb",
      consolidatedTheme.buttonBg
    );
    document.documentElement.style.setProperty(
      "--button-color-rgb",
      consolidatedTheme.buttonFg
    );
    document.documentElement.style.setProperty(
      "--sidebar-bg-rgb",
      consolidatedTheme.sidebarBg
    );
    document.documentElement.style.setProperty(
      "--sidebar-text-rgb",
      consolidatedTheme.sidebarFg
    );
    document.documentElement.style.setProperty(
      "--link-color-rgb",
      consolidatedTheme.link
    );
    document.documentElement.style.setProperty(
      "--sidebar-text-active-border-rgb",
  ...
  document.documentElement.style.setProperty(
    "--sidebar-white-logo",
    consolidatedTheme.sidebarWhiteLogo
  );
  document.documentElement.style.setProperty(
    "--link-visited-color-rgb",
    consolidatedTheme.linkVisited
  );
  ...
  document.documentElement.style.setProperty(
    "--prop-default",
    consolidatedTheme.propDefault
  );
  document.documentElement.style.setProperty(
    "--prop-gray",
    consolidatedTheme.propGray
  );
  document.documentElement.style.setProperty(
    "--prop-brown",
    consolidatedTheme.propBrown
  );
  document.documentElement.style.setProperty(
    "--prop-orange",
    consolidatedTheme.propOrange
  );
  document.documentElement.style.setProperty(
    "--prop-yellow",
    consolidatedTheme.propYellow
  );
  document.documentElement.style.setProperty(
    "--prop-green",
    consolidatedTheme.propGreen
  );
  document.documentElement.style.setProperty(
    "--prop-blue",
    consolidatedTheme.propBlue
  );
  document.documentElement.style.setProperty(
    "--prop-purple",
    consolidatedTheme.propPurple
  );
  document.documentElement.style.setProperty(
    "--prop-pink",
    consolidatedTheme.propPink
  );
  document.documentElement.style.setProperty(
    "--prop-red",
    consolidatedTheme.propRed
  );

  return consolidatedTheme;
}

export function setMattermostTheme(theme) {
  if (!theme) {
  ...
  document.documentElement.style.setProperty(
    "--center-channel-bg-rgb",
    color(theme.centerChannelBg).rgb().array().join(", ")
  );
  document.documentElement.style.setProperty(
    "--center-channel-color-rgb",
    color(theme.centerChannelColor).rgb().array().join(", ")
  );
  document.documentElement.style.setProperty(
    "--button-bg-rgb",
    color(theme.buttonBg).rgb().array().join(", ")
  );
  document.documentElement.style.setProperty(
    "--button-color-rgb",
    color(theme.buttonColor).rgb().array().join(", ")
  );
  document.documentElement.style.setProperty(
    "--sidebar-bg-rgb",
    color(theme.sidebarBg).rgb().array().join(", ")
  );
  document.documentElement.style.setProperty(
    "--sidebar-text-rgb",
    color(theme.sidebarText).rgb().array().join(", ")
  );
  document.documentElement.style.setProperty(
    "--link-color-rgb",
    theme.linkColor
  ...
  document.documentElement.style.setProperty(
    "--sidebar-text-active-border-rgb",
    color(theme.sidebarTextActiveBorder).rgb().array().join(", ")
  );
  ...
  return setTheme({
    ...
    sidebarFg: color(theme.sidebarColor || "#ffffff")
      .rgb()
      .array()
      .join(", "),
    sidebarTextActiveBorder: color(theme.sidebarTextActiveBorder)
      .rgb()
      .array()
      .join(", "),
...
function setActiveThemeName(consolidatedTheme, theme) {
  if (theme === null) {
